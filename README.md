...
The function names are the same as the ones in C version of TA-Lib. The constants in C are all functions in Fortran. The constants use the same names in Fortran. 
